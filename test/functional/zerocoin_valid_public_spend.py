...
from fake_stake.base_test import CIRCUIT_FakeStakeTest

class zCRCTValidCoinSpendTest(CIRCUIT_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zCRCTs..." % DENOM_TO_USE)
