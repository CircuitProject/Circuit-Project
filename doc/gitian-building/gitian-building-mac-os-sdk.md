...
The script [extract-osx-sdk.sh](https://github.com/circuit-project/circuit/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
circuit/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/circuit-project/circuit/blob/master/doc/README_osx.md) for troubleshooting tips.