...
RESOURCES += src/qt/circuit.qrc src/qt/circuit_locale.qrc

TRANSLATIONS += src/qt/locale/circuit_bg.ts \
                src/qt/locale/circuit_de.ts \
                src/qt/locale/circuit_en.ts \
                src/qt/locale/circuit_es.ts \
                src/qt/locale/circuit_fi.ts \
                src/qt/locale/circuit_fr.ts \
                src/qt/locale/circuit_it.ts \
                src/qt/locale/circuit_ja.ts \
                src/qt/locale/circuit_pl.ts \
                src/qt/locale/circuit_pt.ts \
                src/qt/locale/circuit_ru.ts \
                src/qt/locale/circuit_sk.ts \
                src/qt/locale/circuit_sv.ts \
