Contributing to CIRCUIT Core
============================

The CIRCUIT Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/circuit-project/circuit/blob/master/doc/translation_process.md)
...
The following applies to code changes to the CIRCUIT Core project, and is not to be
confused with overall CIRCUIT Network Protocol consensus changes.

Whether a pull request is merged into CIRCUIT Core rests with the project merge
...
Patches that change CIRCUIT consensus rules are considerably more involved than
...
Where a patchset proposes to change the CIRCUIT consensus, it must have been
...
The project leader is the release manager for each CIRCUIT Core release.
