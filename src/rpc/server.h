...
extern UniValue DoZcrctSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzcrctseed(const UniValue& params, bool fHelp);
extern UniValue getzcrctseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzcrct(const UniValue& params, bool fHelp);
extern UniValue dzcrctstate(const UniValue& params, bool fHelp);
