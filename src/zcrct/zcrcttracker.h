...
#ifndef CIRCUIT_ZCRCTTRACKER_H
#define CIRCUIT_ZCRCTTRACKER_H
...
public:
    CzCRCTTracker(std::string strWalletFile);
    ~CzCRCTTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzCRCTWallet* zCRCTWallet = NULL);
