...
#ifndef CIRCUIT_ZCRCTWALLET_H
#define CIRCUIT_ZCRCTWALLET_H
...
public:
    CzCRCTWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZCRCT(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCRCT(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
