...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "circuit" is a composite category enabling all CIRCUIT-related debug output
            if (ptrCategory->count(std::string("circuit"))) {
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "circuit.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "circuitd.pid"));
