                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCRCTPathCustom = GetArg("-zcrctbackuppath", "");
    ...
    if(!strzCRCTPathCustom.empty()) {
        ui->wallet_customzcrctbackuppath->setText(QString::fromStdString(strzCRCTPathCustom));
        ui->wallet_customzcrctbackuppath_label->setVisible(true);
        ui->wallet_customzcrctbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCRCTPathCustom.empty()) && nCustomBackupThreshold > 0) {
