...
// Copyright (c) 2016-2019 The CIRCUIT developers
...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("CRCT Stake");
    case TransactionRecord::StakeZCRCT:
        return tr("zCRCT Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted CRCT to zCRCT");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zCRCT");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received CRCT from zCRCT");
    case TransactionRecord::ZerocoinSpend_Change_zCrct:
        return tr("Minted Change as zCRCT from zCRCT Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zCRCT to CRCT");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zCrct:
        return tr("Anonymous (zCRCT Transaction)");
    case TransactionRecord::StakeZCRCT:
        return tr("Anonymous (zCRCT Stake)");
    case TransactionRecord::SendToSelf:
    default:
