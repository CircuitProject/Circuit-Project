...
#ifndef CIRCUIT_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define CIRCUIT_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //CIRCUIT_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
