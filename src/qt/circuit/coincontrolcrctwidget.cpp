...
#include "qt/circuit/coincontrolcrctwidget.h"
#include "qt/circuit/forms/ui_coincontrolcrctwidget.h"

CoinControlCrctWidget::CoinControlCrctWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlCrctWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select CRCT Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("CRCT");
    ...
    ui->labelValueAfter->setText("0.00 CRCT");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 CRCT");
    ui->labelValueFee->setText("0.00 CRCT");
...
CoinControlCrctWidget::~CoinControlCrctWidget()
{
    delete ui;
}
