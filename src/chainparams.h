...
public:
    ...
    int CircuitBadBlockTime() const { return nCircuitBadBlockTime; }
    int CircuitBadBlocknBits() const { return nCircuitBadBlocknBits; }
...
protected:
    ...
    unsigned int nCircuitBadBlocknBits;
